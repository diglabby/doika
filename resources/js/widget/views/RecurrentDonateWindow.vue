...
export default {
  ...
  .credit-card {
    ...
    height: 186px;
    position:relative;
    background: url("${parent.document.location.protocol}//${parent.document.location.host}/doika/images/front-card.png"),
    url("${parent.document.location.protocol}//${parent.document.location.host}/doika/images/back-card.png");

export default (app, i18n, newPostsCount, pendingPostsCount) => {
  return [
    {
      name: i18n.t('labels.client.titles.dashboard'),
      url: '/dashboard',
    ...
    {
      title: true,
      name: i18n.t('labels.client.sidebar.content'),
      access: app.blogEnabled && app.user.can('view own posts')
    },
    {
      name: i18n.t('labels.client.posts.titles.main'),
      url: '/posts',
      icon: 'fe fe-book',
      access: app.blogEnabled && app.user.can('view own posts')
    },
    ...
    {
      title: true,
      name: i18n.t('labels.client.sidebar.forms'),
      access:
        app.user.can('view form_submissions') ||
        app.user.can('view form_settings')
    },
    {
      name: i18n.t('labels.client.form_submissions.titles.main'),
      url: '/form-submissions',
      icon: 'fe fe-list',
      access: app.user.can('view form_submissions')
    },
    {
      name: i18n.t('labels.client.form_settings.titles.main'),
      url: '/form-settings',
      icon: 'fe fe-sliders',
    ...
    {
      title: true,
      name: i18n.t('labels.client.sidebar.access'),
      access: app.user.can('view users') || app.user.can('view roles')
    },
    {
      name: i18n.t('labels.client.users.titles.main'),
      url: '/users',
      icon: 'fe fe-users',
      access: app.user.can('view users')
    },
    {
      name: i18n.t('labels.client.roles.titles.main'),
      url: '/roles',
      icon: 'fe fe-shield',
    ...
    {
      title: true,
      name: i18n.t('labels.client.sidebar.seo'),
      access: app.user.can('view metas') || app.user.can('view redirections')
    },
    {
      name: i18n.t('labels.client.metas.titles.main'),
      url: '/metas',
      icon: 'fe fe-tag',
      access: app.user.can('view metas')
    },
    {
      name: i18n.t('labels.client.redirections.titles.main'),
      url: '/redirections',

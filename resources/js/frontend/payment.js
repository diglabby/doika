;(function() {
  ...
  function back() {
    ...
    } else window.parent.postMessage(['doikaMain', true], '*')
  }
  ...
  function init() {
    switch (window.parent.doika.status) {
      case 'success':
        ...
        title.style.background =
          'url(assets/img/success.png) center center no-repeat'
        ...
        toMain = true
        document
          .querySelector('.module-donate__message_button')
      ...
      case 'decline':
        ...
        var title = document.querySelector('.module-donate__message_title')
        title.style.background =
          'url(assets/img/decline.png) center center no-repeat'
        title.style.backgroundSize = 'contain'
      ...
      case 'fail':
        ...
        var title = document.querySelector('.module-donate__message_title')
        title.innerHTML =
          'Прабачце,транзакцыя была адхiлена з прычыны тэхнiчнага збою'
        title.style.background =
          'url(assets/img/fail.png) center center no-repeat'
        title.style.backgroundSize = 'contain'
        var button = document.querySelector('.module-donate__message_button')
        button.innerHTML = 'Паспрабаваць яшчэ раз'
        var backbutton = document.querySelector('.module-donate__back-button')
      ...
      default:
        ...
        var url =
          '/doika/donate-' +
          window.parent.doika.campaignId +
          '?donate=' +
          window.parent.doikaSum +
          backUrl
    ...
    document
      .querySelector('.module-donate__back-button')
      .addEventListener('click', back)

    loadDataConfig()
    loadConfig()
    document
      .querySelector('#donate-bePaid__form')
      .addEventListener('load', updateIframeHeight)
  }

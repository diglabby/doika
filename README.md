...
6. З тэрмінала запусціць каманду `npm install`. Вы павінны запусціць з карнявой дырэкторыі doika. Пры узнікненні памылак з node-sass выпаўняем `sudo npm install -g --unsafe-perm node-sass`

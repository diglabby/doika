![image](https://img.shields.io/github/release-pre/diglabby/doika.svg)
...
Падрабязней глядзець [дарожную мапу](https://github.com/diglabby/doika/wiki/Дарожная-карта).

...
[Праца з рэквэстамі](Праца-з-Pull-Request)


## Як пачаць распрацоўку?
1. Праглядзець статус і роадмэп распрацоукi праекта.
2. Як разгарнуць лакальны асяродак для распрацоўкі і усталяваць сабе па [інструкцыі](Усталёўка-для-Распрацоўшчыкаў).
